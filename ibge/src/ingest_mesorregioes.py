...
tabela_destino = f"{used_catalog}.{used_schema}.raw_mesorregioes"
...
# Endpoint oficial de mesorregiões
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para mesorregiões.")
