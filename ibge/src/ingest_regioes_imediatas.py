...
tabela_destino = f"{used_catalog}.{used_schema}.raw_regioes_imediatas"
...
# Endpoint oficial de regiões imediatas
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para regiões imediatas.")
