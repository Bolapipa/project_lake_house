...
tabela_destino = f"{used_catalog}.{used_schema}.raw_subdistritos"
...
# Endpoint oficial de subdistritos
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para subdistritos.")
