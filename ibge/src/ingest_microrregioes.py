...
tabela_destino = f"{used_catalog}.{used_schema}.raw_microrregioes"
...
# Endpoint oficial de microrregiões
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para microrregiões.")
