...
tabela_destino = f"{used_catalog}.{used_schema}.raw_ufs"
...
# Endpoint oficial de UFs (estados)
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para UFs.")

# Cria o DataFrame Spark com os dados novos
df_novos = spark.createDataFrame(dados)
