...
tabela_destino = f"{used_catalog}.{used_schema}.raw_regioes_integradas_desenvolvimento"
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para regiões integradas de desenvolvimento.")
