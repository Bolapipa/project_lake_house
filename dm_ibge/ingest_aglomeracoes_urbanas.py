...
tabela_destino = f"{used_catalog}.{used_schema}.raw_aglomeracoes_urbanas"
...
# Endpoint oficial de aglomerações urbanas
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para aglomerações urbanas.")
