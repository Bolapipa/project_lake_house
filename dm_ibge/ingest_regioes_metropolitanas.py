...
tabela_destino = f"{used_catalog}.{used_schema}.raw_regioes_metropolitanas"
...
# Endpoint oficial de regiões metropolitanas
...
if not dados:
    raise ValueError("A API do IBGE retornou uma lista vazia para regiões metropolitanas.")
