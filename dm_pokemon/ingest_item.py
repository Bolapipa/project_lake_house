...
tabela_destino = f"{used_catalog}.{used_schema}.raw_pokemon_items"
...
df_item.write.mode("append").saveAsTable(f"{used_catalog}.{used_schema}.raw_pokemon_items")
...
if all_rows_items:
    ...
    spark.sql(f"""
        ...
        SET raw_pokemon_items = {ultimo_id_ingestao}
        WHERE id = 1
    """)
